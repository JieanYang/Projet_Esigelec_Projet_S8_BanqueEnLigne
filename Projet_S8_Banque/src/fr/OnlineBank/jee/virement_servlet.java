...
public class virement_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String date_transaction = request.getParameter("date_transaction");// declarer une variable date_transaction et
																			// la recuperé en string par défaut
	...
	private static java.sql.Date convertUtilToSql(java.util.Date uDate) {// Fonction qui permet de convertir la date en
																			// une version insérable dans la BDD
