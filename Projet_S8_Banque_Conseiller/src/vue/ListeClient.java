...
import controleur.ControleurListeClient;
import dto.User;
...
public class ListeClient extends JPanel {
	...
	private static ControleurListeClient cListeClient = new ControleurListeClient();
	private Vector<User> userList = new Vector<>(ListeClient.getListOfClient());
	
	public static Vector<User> getListOfClient() {
		return cListeClient.getListClient();
	}
